...
data class AppColors(
    ...
    val glassCardElevated: Color,       // Stronger opacity for floating cards
    val glassCardElevatedBorder: Color, // Border for elevated cards
    val glassFloating: Color,           // Glass for floating overlays (search bar, pills)
    val glassFloatingBorder: Color,     // Border for floating glass
    val glassSheetBackground: Color,    // Modal bottom sheet / dialog glass
    // ── Standard Colors ──────────────────────────────────────────────────────
...
val DarkColors = AppColors(
    // Deeper backgrounds for stronger glass pop
    bg0 = Color(0xFF06050B), bg1 = Color(0xFF0C0A16), bg2 = Color(0xFF141020),
    ...
    // Liquid Glass — dark mode (boosted for stronger glass effect)
    liquidGlass = Color(0x25FFFFFF),
    liquidGlassBorder = Color(0x38FFFFFF),
    liquidGlassHighlight = Color(0x50FFFFFF),
    liquidGlassClear = Color(0x12FFFFFF),
    liquidGlassClearBorder = Color(0x22FFFFFF),
    glassTint = Color(0x8C141020),
    glassShadow = Color(0x50000000),
    glassShadowStrong = Color(0x80000000),
    glassGlow = Color(0x40C77DFF),
    glassInnerShadow = Color(0x28FFFFFF),
    glassRimLight = Color(0x66FFFFFF),
    // Elevated glass (floating cards, dialogs)
    glassCardElevated = Color(0x30FFFFFF),
    glassCardElevatedBorder = Color(0x40FFFFFF),
    glassFloating = Color(0x20FFFFFF),
    glassFloatingBorder = Color(0x35FFFFFF),
    glassSheetBackground = Color(0xE00E0C1A),
...
val LightColors = AppColors(
    ...
    // Liquid Glass — light mode (boosted)
    liquidGlass = Color(0xCCFFFFFF),
    liquidGlassBorder = Color(0x28000000),
    liquidGlassHighlight = Color(0xF5FFFFFF),
    liquidGlassClear = Color(0x90FFFFFF),
    liquidGlassClearBorder = Color(0x18000000),
    glassTint = Color(0x8CFFFFFF),
    glassShadow = Color(0x22000000),
    glassShadowStrong = Color(0x40000000),
    glassGlow = Color(0x309D4EDD),
    glassInnerShadow = Color(0x12000000),
    glassRimLight = Color(0xEEFFFFFF),
    // Elevated glass
    glassCardElevated = Color(0xDDFFFFFF),
    glassCardElevatedBorder = Color(0x30000000),
    glassFloating = Color(0xBBFFFFFF),
    glassFloatingBorder = Color(0x20000000),
...
object Radius {
    val xs = 6.dp; val sm = 10.dp; val md = 14.dp; val lg = 18.dp; val xl = 24.dp; val xxl = 32.dp
